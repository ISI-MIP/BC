...
;; ISI-MIP method corrects monthly mean and daily variablity
;; separately
;; monthly mean is corrected by the mean ratio over the whole
;; construction period
;; dialy variability is corrected by fitting a transfer function for
;; the normalised daily values (devided by the mean of the current
;; month)
...
cutoff_mean = 0.01              ; cut-off for monthly mean value in WFD to be considered as dry

;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
;***************************************************************
;***************************************************************
;***************************************************************
; read model and WATCH data, check consistency and initialize arrays
;***************************************************************
;***************************************************************
;***************************************************************
;+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
; ... to the output file
outfile = outputdir+'pr_cor_'+construction_period+'_'+month(mon)+'_'+runToCorrect+'_test.dat'
...
pr_o=idldata*86400.0D           ; convert unit to precipitation per day
...
s_e2 = fltarr(NUMLANDPOINTS)    ; threshold for outlier in  model data
s_o = fltarr(NUMLANDPOINTS)     ; threshold for dry days in WFD
s_o2 = fltarr(NUMLANDPOINTS)    ; threshold for outlier in WFD
